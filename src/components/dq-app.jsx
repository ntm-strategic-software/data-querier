...
class DqApp extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const { dataSource, data, dataSummary, dataByOrganization, dataByLocation, dataByOS, dataByLocale, products, selectedProduct } = this.state;
        ...
        const computeData = ({ newDataSource, productSelected }) => {
            ...
            const extraStuff = newDataSource ?
                {
